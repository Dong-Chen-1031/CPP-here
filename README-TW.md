...
- **後端**: FastAPI, PyJWT, PyTurnstile, Python, SQLAlchemy, Uvicorn, aiodocker, aiofiles, aiosqlite, apscheduler, [safe-cpp2wasm](builder/)

## 原理及優勢

C++ Here 與其他線上 C++ 編輯器的最大不同在於我們使用 [safe-cpp2wasm](builder/) 將 C++ 檔案編譯成 WebAssembly，並在前端直接執行。這種方式的優勢在於：
