/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 41a80f19d17e0554259a53fa16cc8e22)
// Runtime types generated with workerd@1.20260124.0 2026-06-19 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		PUBLIC_TURNSTILE_SITE_KEY: string;
		PUBLIC_SHARE: string;
		PUBLIC_S3_BUCKET_URL: string;
		SKIP_API_FETCH: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_TURNSTILE_SITE_KEY" | "PUBLIC_SHARE" | "PUBLIC_S3_BUCKET_URL" | "SKIP_API_FETCH">> {}
}
