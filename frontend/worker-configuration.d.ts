/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 179c0e1e202b9c13381be7c8d57f34dd)
// Runtime types generated with workerd@1.20260617.1 2026-06-19 nodejs_compat
interface __BaseEnv_Env {
	PUBLIC_TURNSTILE_SITE_KEY: string;
	PUBLIC_SHARE: string;
	PUBLIC_S3_BUCKET_URL: string;
	PUBLIC_SKIP_API_FETCH: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_TURNSTILE_SITE_KEY" | "PUBLIC_SHARE" | "PUBLIC_S3_BUCKET_URL" | "PUBLIC_SKIP_API_FETCH">> {}
}
